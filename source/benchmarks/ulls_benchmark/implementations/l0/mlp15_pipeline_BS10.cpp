...
static std::vector<ze_kernel_handle_t> get_kernels(const LevelZero& levelzero) {
    ...
    cl_int retVal;
    std::ifstream file("/home/tchariti/ericsson/compute-benchmarks/source/benchmarks/ulls_benchmark/kernels/copyable_sources/MLP_13-15_sync_BS10_cldumps/clDNN_program_1_bucket_0_part_0_2668331072921733207_adls.bin");
    ...
    cl_kernel kernel0 = clCreateKernel(program, "reorder_data_5570928500925804313_0", &retVal);
    cl_kernel kernel1 = clCreateKernel(program, "fully_connected_gpu_bf_tiled_4028700128260651592_0", &retVal);
    cl_kernel kernel2 = clCreateKernel(program, "fully_connected_gpu_bf_tiled_17903421672701997615_0", &retVal);
    cl_kernel kernel3 = clCreateKernel(program, "fully_connected_gpu_bf_tiled_17903421672701997615_0", &retVal);
    cl_kernel kernel4 = clCreateKernel(program, "fully_connected_gpu_bf_tiled_17903421672701997615_0", &retVal);
    cl_kernel kernel5 = clCreateKernel(program, "fully_connected_gpu_bf_tiled_18033239253677070461_0", &retVal);
    cl_kernel kernel6 = clCreateKernel(program, "softmax_gpu_bf_7946080407788828040_0", &retVal);
    cl_kernel kernel7 = clCreateKernel(program, "reorder_data_15652857777958573679_0", &retVal);

    std::vector<ze_kernel_handle_t> kernels;
    kernels.push_back(create_ze_kernel(levelzero, kernel0, "reorder_data_5570928500925804313_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel1, "fully_connected_gpu_bf_tiled_4028700128260651592_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel2, "fully_connected_gpu_bf_tiled_17903421672701997615_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel3, "fully_connected_gpu_bf_tiled_17903421672701997615_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel4, "fully_connected_gpu_bf_tiled_17903421672701997615_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel5, "fully_connected_gpu_bf_tiled_18033239253677070461_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel6, "softmax_gpu_bf_7946080407788828040_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel7, "reorder_data_15652857777958573679_0"));

    return kernels;
}

static TestResult run(const MLP15PipelineBS10Arguments &arguments, Statistics &statistics) {
    ...
    ze_group_count_t gws0 = {1, 64, 10};
    std::vector<uint32_t> lws0 = {1, 64, 5};
    ...
    ze_group_count_t gws6 = {16, 10, 1};
    std::vector<uint32_t> lws6 = {16, 1, 1};

    ze_group_count_t gws7 = {1, 128, 10};
    std::vector<uint32_t> lws7 = {1, 128, 2};
    ...
    ASSERT_ZE_RESULT_SUCCESS(zeMemAllocDevice(levelzero.context, &deviceAllocationDesc, 2560, 0, levelzero.device, &mem0));
    ASSERT_ZE_RESULT_SUCCESS(zeMemAllocDevice(levelzero.context, &deviceAllocationDesc, 1280, 0, levelzero.device, &mem1));
    ASSERT_ZE_RESULT_SUCCESS(zeMemAllocDevice(levelzero.context, &deviceAllocationDesc, 10240, 0, levelzero.device, &mem2));
    ASSERT_ZE_RESULT_SUCCESS(zeMemAllocDevice(levelzero.context, &deviceAllocationDesc, 10240, 0, levelzero.device, &mem3));
    ASSERT_ZE_RESULT_SUCCESS(zeMemAllocDevice(levelzero.context, &deviceAllocationDesc, 5120, 0, levelzero.device, &mem4));
    ASSERT_ZE_RESULT_SUCCESS(zeMemAllocDevice(levelzero.context, &deviceAllocationDesc, 2560, 0, levelzero.device, &mem5));
    ...
    void* reorder0_in = mem0; // input buffer
    ...
    void* softmax_out = mem5;

    void* reorder1_in = mem5;
    void* reorder1_out = mem4; // output buffer
    ...
    ASSERT_ZE_RESULT_SUCCESS(zeMemFree(levelzero.context, mem5));
...
static RegisterTestCaseImplementation<MLP15PipelineBS10> registerTestCase(run, Api::L0);

...
static std::vector<ze_kernel_handle_t> get_kernels(const LevelZero& levelzero) {
    ...
    cl_kernel kernel3 = clCreateKernel(program, "fully_connected_gpu_bf_tiled_6071254260507684775_0", &retVal);
    cl_kernel kernel4 = clCreateKernel(program, "fully_connected_gpu_bf_tiled_6071254260507684775_0", &retVal);
    cl_kernel kernel5 = clCreateKernel(program, "fully_connected_gpu_bf_tiled_6071254260507684775_0", &retVal);
    cl_kernel kernel6 = clCreateKernel(program, "fully_connected_gpu_bf_tiled_6071254260507684775_0", &retVal);
    cl_kernel kernel7 = clCreateKernel(program, "fully_connected_gpu_bf_tiled_6071254260507684775_0", &retVal);
    cl_kernel kernel8 = clCreateKernel(program, "fully_connected_gpu_bf_tiled_6071254260507684775_0", &retVal);
    cl_kernel kernel9 = clCreateKernel(program, "fully_connected_gpu_bf_tiled_13179863444430652434_0", &retVal);
    cl_kernel kernel10 = clCreateKernel(program, "softmax_gpu_bf_7961204449418089128_0", &retVal);
    cl_kernel kernel11 = clCreateKernel(program, "reorder_data_14703086585509440127_0", &retVal);
    ...
    kernels.push_back(create_ze_kernel(levelzero, kernel3, "fully_connected_gpu_bf_tiled_6071254260507684775_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel4, "fully_connected_gpu_bf_tiled_6071254260507684775_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel5, "fully_connected_gpu_bf_tiled_6071254260507684775_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel6, "fully_connected_gpu_bf_tiled_6071254260507684775_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel7, "fully_connected_gpu_bf_tiled_6071254260507684775_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel8, "fully_connected_gpu_bf_tiled_6071254260507684775_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel9, "fully_connected_gpu_bf_tiled_13179863444430652434_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel10, "softmax_gpu_bf_7961204449418089128_0"));
    kernels.push_back(create_ze_kernel(levelzero, kernel11, "reorder_data_14703086585509440127_0"));   

    return kernels;
}

static TestResult run(const MLP12PipelineBS10Arguments &arguments, Statistics &statistics) {
    ...
    ze_group_count_t gws10 = {8, 10, 1};
    std::vector<uint32_t> lws10 = {8, 1, 1};

    ze_group_count_t gws11 = {1, 64, 10};
    std::vector<uint32_t> lws11 = {1, 64, 5}; 
    ...
    ASSERT_ZE_RESULT_SUCCESS(zeMemAllocDevice(levelzero.context, &deviceAllocationDesc, 640, 0, levelzero.device, &mem2));
    ASSERT_ZE_RESULT_SUCCESS(zeMemAllocDevice(levelzero.context, &deviceAllocationDesc, 2560, 0, levelzero.device, &mem3));
    ASSERT_ZE_RESULT_SUCCESS(zeMemAllocDevice(levelzero.context, &deviceAllocationDesc, 2560, 0, levelzero.device, &mem4));
    ASSERT_ZE_RESULT_SUCCESS(zeMemAllocDevice(levelzero.context, &deviceAllocationDesc, 1280, 0, levelzero.device, &mem5));
    ...
    void* softmax_in = mem0;
    void* softmax_out = mem5;

    void* reorder1_in = mem5;
    void* reorder1_out = mem3; //final result buffer
...
static RegisterTestCaseImplementation<MLP12PipelineBS10> registerTestCase(run, Api::L0);

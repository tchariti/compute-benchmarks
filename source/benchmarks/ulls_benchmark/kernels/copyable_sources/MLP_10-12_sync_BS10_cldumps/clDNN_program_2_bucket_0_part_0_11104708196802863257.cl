...
// Kernel name: reorder_weights_opt_48_weight_0
#define KERNEL(name) __kernel void reorder_weights_opt_48_weight_0
#define FUNC(name)  _##name##_reorder_weights_opt_48_weight_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_48_weight_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_48_weight_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_48_weight_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
#define INPUT0_SIZE_Z 1
#define INPUT0_IFM_NUM 32
...
#define INPUT0_SIZES_DATA { 1,1,32,128,1,1,1,1,1, } 
...
#define OUTPUT_SIZES_DATA { 1,1,32,128,1,1,1,1,1, } 
...
//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_41_weight_0
#define KERNEL(name) __kernel void reorder_weights_opt_41_weight_0
#define FUNC(name)  _##name##_reorder_weights_opt_41_weight_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_41_weight_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_41_weight_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_41_weight_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
...
#define INPUT0_Z_PITCH 1
#define INPUT0_IFM_PITCH 1
#define INPUT0_OFM_PITCH 128
#define INPUT0_GROUPS_PITCH 1
#define INPUT0_VIEW_OFFSET 0
#define INPUT0_LENGTH 16384
#define INPUT0_DIMS 4
#define INPUT0_SIMPLE 1
#define INPUT0_GROUPED 0
#define INPUT0_LAYOUT_OIYX 1
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 1,1,128,128,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 1,1,128,128,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
...
//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_40_weight_0
#define KERNEL(name) __kernel void reorder_weights_opt_40_weight_0
#define FUNC(name)  _##name##_reorder_weights_opt_40_weight_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_40_weight_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_40_weight_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_40_weight_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 1,1,128,64,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
#define INPUT0_PITCHES (size_t []){ 1,1,1,128,1,1,1,1,1, } 
#define INPUT0_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 1,1,128,64,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,1,1,128,1,1,1,1,1, } 
#define OUTPUT_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 

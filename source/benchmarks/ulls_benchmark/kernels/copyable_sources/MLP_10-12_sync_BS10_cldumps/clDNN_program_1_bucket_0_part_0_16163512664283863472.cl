...
// Kernel name: reorder_data_14703086585509440127_0
#define KERNEL(name) __kernel void reorder_data_14703086585509440127_0
#define FUNC(name)  _##name##_reorder_data_14703086585509440127_0
#define FUNC_CALL(name)  _##name##_reorder_data_14703086585509440127_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_data_14703086585509440127_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_data_14703086585509440127_0
...
// Kernel name: softmax_gpu_bf_7961204449418089128_0
#define KERNEL(name) __kernel void softmax_gpu_bf_7961204449418089128_0
#define FUNC(name)  _##name##_softmax_gpu_bf_7961204449418089128_0
#define FUNC_CALL(name)  _##name##_softmax_gpu_bf_7961204449418089128_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_softmax_gpu_bf_7961204449418089128_0 []
#define CONST_ARRAY_REF(name)  _##name##_softmax_gpu_bf_7961204449418089128_0
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
...
// Kernel name: fully_connected_gpu_bf_tiled_13179863444430652434_0
#define KERNEL(name) __kernel void fully_connected_gpu_bf_tiled_13179863444430652434_0
#define FUNC(name)  _##name##_fully_connected_gpu_bf_tiled_13179863444430652434_0
#define FUNC_CALL(name)  _##name##_fully_connected_gpu_bf_tiled_13179863444430652434_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_fully_connected_gpu_bf_tiled_13179863444430652434_0 []
#define CONST_ARRAY_REF(name)  _##name##_fully_connected_gpu_bf_tiled_13179863444430652434_0
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 64,10,1,1,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
...
#define FILTER_SIZES_DATA { 1,1,128,64,1,1,1,1,1, } 
...
#define TILE_OUT_F_NUM 64
#define TILE_OUT_F_PITCH 1
#define TILE_IN_B_PITCH 128
#define TILE_OUT_B_PITCH 64
...
//====================================================
// Kernel template: fully_connected_gpu_bf_tiled 
// Kernel name: fully_connected_gpu_bf_tiled_6071254260507684775_0
#define KERNEL(name) __kernel void fully_connected_gpu_bf_tiled_6071254260507684775_0
#define FUNC(name)  _##name##_fully_connected_gpu_bf_tiled_6071254260507684775_0
#define FUNC_CALL(name)  _##name##_fully_connected_gpu_bf_tiled_6071254260507684775_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_fully_connected_gpu_bf_tiled_6071254260507684775_0 []
#define CONST_ARRAY_REF(name)  _##name##_fully_connected_gpu_bf_tiled_6071254260507684775_0
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
...
#define FILTER_IS_FP 1
#define FILTER_OFFSET 0
#define FILTER_SIZES_DATA { 1,1,128,128,1,1,1,1,1, } 
CONST_ARRAY_DECL(FILTER_SIZES) = FILTER_SIZES_DATA;
#define FILTER_SIZES CONST_ARRAY_REF(FILTER_SIZES)
#define FILTER_PITCHES (size_t []){ 1,1,1,128,1,1,1,1,1, } 
#define FILTER_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
...
//====================================================
// Kernel template: fully_connected_gpu_bf_tiled 
// Kernel name: fully_connected_gpu_bf_tiled_2485442293408685635_0
#define KERNEL(name) __kernel void fully_connected_gpu_bf_tiled_2485442293408685635_0
#define FUNC(name)  _##name##_fully_connected_gpu_bf_tiled_2485442293408685635_0
#define FUNC_CALL(name)  _##name##_fully_connected_gpu_bf_tiled_2485442293408685635_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_fully_connected_gpu_bf_tiled_2485442293408685635_0 []
#define CONST_ARRAY_REF(name)  _##name##_fully_connected_gpu_bf_tiled_2485442293408685635_0
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 1,1,32,10,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
...
#define FILTER_IS_FP 1
#define FILTER_OFFSET 0
#define FILTER_SIZES_DATA { 1,1,32,128,1,1,1,1,1, } 
CONST_ARRAY_DECL(FILTER_SIZES) = FILTER_SIZES_DATA;
#define FILTER_SIZES CONST_ARRAY_REF(FILTER_SIZES)
#define FILTER_PITCHES (size_t []){ 1,1,1,32,1,1,1,1,1, } 
#define FILTER_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define FILTER_PAD_AFTER (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define BIAS_TERM 1
#define BIAS_SIZE_X 1
...
//====================================================
// Kernel template: reorder_data 
// Kernel name: reorder_data_8651755562007300334_0
#define KERNEL(name) __kernel void reorder_data_8651755562007300334_0
#define FUNC(name)  _##name##_reorder_data_8651755562007300334_0
#define FUNC_CALL(name)  _##name##_reorder_data_8651755562007300334_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_data_8651755562007300334_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_data_8651755562007300334_0
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 1,1,32,10,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)

...
// Kernel name: reorder_weights_48_weight_0
#define KERNEL(name) __kernel void reorder_weights_48_weight_0
#define FUNC(name)  _##name##_reorder_weights_48_weight_0
#define FUNC_CALL(name)  _##name##_reorder_weights_48_weight_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_48_weight_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_48_weight_0
...
#define OUTPUT_LAYOUT_OS_I_OSV16 1
...
#define OUTPUT_SIZES_DATA { 32,128,1,1,1,1,1,1,1, } 
...
#endif
#ifdef OUTPUT_LAYOUT_OS_I_OSV16
#undef OUTPUT_LAYOUT_OS_I_OSV16
#endif
#ifdef OUTPUT_TYPE
#undef OUTPUT_TYPE
#endif
...
//====================================================
// Kernel template: reorder_weights 
// Kernel name: reorder_weights_41_weight_0
#define KERNEL(name) __kernel void reorder_weights_41_weight_0
#define FUNC(name)  _##name##_reorder_weights_41_weight_0
#define FUNC_CALL(name)  _##name##_reorder_weights_41_weight_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_41_weight_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_41_weight_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 128,128,1,1,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
...
//====================================================
// Kernel template: reorder_weights 
// Kernel name: reorder_weights_40_weight_0
#define KERNEL(name) __kernel void reorder_weights_40_weight_0
#define FUNC(name)  _##name##_reorder_weights_40_weight_0
#define FUNC_CALL(name)  _##name##_reorder_weights_40_weight_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_40_weight_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_40_weight_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 128,64,1,1,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,128,1,1,1,1,1,1,1, } 
#define OUTPUT_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 

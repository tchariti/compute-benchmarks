...
//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_28_weight_0
#define KERNEL(name) __kernel void reorder_weights_opt_28_weight_0
#define FUNC(name)  _##name##_reorder_weights_opt_28_weight_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_28_weight_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_28_weight_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_28_weight_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
#define INPUT0_SIZE_Z 1
#define INPUT0_IFM_NUM 64
#define INPUT0_OFM_NUM 512
#define INPUT0_GROUPS_NUM 1
#define INPUT0_X_PITCH 1
#define INPUT0_Y_PITCH 1
#define INPUT0_Z_PITCH 1
#define INPUT0_IFM_PITCH 1
#define INPUT0_OFM_PITCH 64
#define INPUT0_GROUPS_PITCH 1
#define INPUT0_VIEW_OFFSET 0
#define INPUT0_LENGTH 32768
...
#define INPUT0_SIZES_DATA { 1,1,64,512,1,1,1,1,1, } 
...
#define OUTPUT_SIZES_DATA { 1,1,64,512,1,1,1,1,1, } 
...
#define OUTPUT_INDEX_FUNC inline uint FUNC(OS_IYX_OSV32)(){return 0;}
#define INIT_OUTPUT_INDEX_FUNC_HERE OUTPUT_INDEX_FUNC
#define GET_OUTPUT_OS_IYX_OSV32_INDEX(prefix, g, o, i, y, x, sub_group_size)  \
    CAT(prefix, _OFFSET) + \
    (g * CAT(prefix, _GROUPS_PITCH)) + \
    ((o) % (sub_group_size)) + \
    (sub_group_size)*( \
...
#define OUTPUT_GET_INDEX(o, i, y, x) GET_OUTPUT_OS_IYX_OSV32_INDEX(OUTPUT, 0, o, i, y, x, 32)
...
#define OFM_SIZE 32
#define OSV_FIRST 1
#define IFM_BLOCK_SIZE 1
#define OFM_BLOCK_SIZE 16
...
#endif
#ifdef OUTPUT_LAYOUT_OS_IYX_OSV32
#undef OUTPUT_LAYOUT_OS_IYX_OSV32
#endif
#ifdef OUTPUT_TYPE
#undef OUTPUT_TYPE
#endif
...
#endif
#ifdef GET_OUTPUT_OS_IYX_OSV32_INDEX
#undef GET_OUTPUT_OS_IYX_OSV32_INDEX
#endif
...
#undef OSV_FIRST
#endif
#ifdef IFM_BLOCK_SIZE
#undef IFM_BLOCK_SIZE
#endif
#ifdef OFM_BLOCK_SIZE
#undef OFM_BLOCK_SIZE
#endif

//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_25_weight_0
#define KERNEL(name) __kernel void reorder_weights_opt_25_weight_0
#define FUNC(name)  _##name##_reorder_weights_opt_25_weight_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_25_weight_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_25_weight_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_25_weight_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
#define INPUT0_SIZE_Z 1
#define INPUT0_IFM_NUM 512
#define INPUT0_OFM_NUM 512
#define INPUT0_GROUPS_NUM 1
#define INPUT0_X_PITCH 1
#define INPUT0_Y_PITCH 1
#define INPUT0_Z_PITCH 1
#define INPUT0_IFM_PITCH 1
#define INPUT0_OFM_PITCH 512
#define INPUT0_GROUPS_PITCH 1
#define INPUT0_VIEW_OFFSET 0
#define INPUT0_LENGTH 262144
#define INPUT0_DIMS 4
#define INPUT0_SIMPLE 1
#define INPUT0_GROUPED 0
#define INPUT0_LAYOUT_OIYX 1
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 1,1,512,512,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
...
#define OUTPUT_Z_PITCH 1
#define OUTPUT_IFM_PITCH 1
#define OUTPUT_OFM_PITCH 512
#define OUTPUT_GROUPS_PITCH 1
#define OUTPUT_VIEW_OFFSET 0
#define OUTPUT_LENGTH 262144
#define OUTPUT_DIMS 4
#define OUTPUT_SIMPLE 0
#define OUTPUT_GROUPED 0
#define OUTPUT_LAYOUT_OS_IYX_OSV32 1
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 1,1,512,512,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,1,1,512,1,1,1,1,1, } 
#define OUTPUT_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define OUTPUT_PAD_AFTER (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define OUTPUT_INDEX_FUNC inline uint FUNC(OS_IYX_OSV32)(){return 0;}
#define INIT_OUTPUT_INDEX_FUNC_HERE OUTPUT_INDEX_FUNC
...
//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_24_weight_0
#define KERNEL(name) __kernel void reorder_weights_opt_24_weight_0
#define FUNC(name)  _##name##_reorder_weights_opt_24_weight_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_24_weight_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_24_weight_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_24_weight_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 1,1,512,128,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
#define INPUT0_PITCHES (size_t []){ 1,1,1,512,1,1,1,1,1, } 
#define INPUT0_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 1,1,512,128,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,1,1,512,1,1,1,1,1, } 
#define OUTPUT_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
